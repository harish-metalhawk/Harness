...
def opts():
    ...
    if  (parse.parse_args()[0].plain and parse.parse_args()[0].current and parse.parse_args()[0].build) or not  (parse.parse_args()[0].plain or parse.parse_args()[0].current or parse.parse_args()[0].build):
        parse.error("invalid args passed")
